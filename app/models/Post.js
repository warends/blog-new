  ...
  Post.find({}).exec(function(err, collection){
    if(collection.length === 0){
      Post.create({
        ...
        "<p>Resources:  Are you the only developer and or designer on the project or are you working with a well-oiled team?  If you are short staffed to hit a deadline are, is there a budget to bring on another developer?</p>"+
        "<div class='triangle pull-right padded'><img src='http://res.cloudinary.com/willarendsdesign-com/image/upload/v1473793658/project-triangle_uycvs6.png' class='img-responsive'/></div>"+
